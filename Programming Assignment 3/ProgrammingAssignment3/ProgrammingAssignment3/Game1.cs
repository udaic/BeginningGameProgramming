...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            rockUno = Content.Load<Texture2D>(@"graphics\greenrock");
            rockDuos = Content.Load<Texture2D>(@"graphics\magentarock");
            rockTres = Content.Load<Texture2D>(@"graphics\whiterock");

            
            alphaRock = GetRandomRock();
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (alphaRock != null)
            {
                alphaRock.Update(gameTime);
            }
            if (betaRock != null)
            {
                betaRock.Update(gameTime);
            }
            if (gammaRock != null)
            {
                gammaRock.Update(gameTime);
            }
            ...
            if (elapsedDelayMilliseconds >= TotalDelayMilliseconds)
            {
                ...
                else if (betaRock == null)
                {
                    betaRock = GetRandomRock();
                }
                else if (gammaRock == null)
                {
                    gammaRock = GetRandomRock();
                }
            ...
            if (alphaRock != null && alphaRock.OutsideWindow)
            {
                alphaRock = GetRandomRock();
            }
            if (betaRock != null && betaRock.OutsideWindow)
            {
                betaRock = GetRandomRock();
            }
            if (gammaRock != null && gammaRock.OutsideWindow)
            {
                gammaRock = GetRandomRock();
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            if(alphaRock != null)
                alphaRock.Draw(spriteBatch);
            if(betaRock != null)
                betaRock.Draw(spriteBatch);
            if(gammaRock != null)
                gammaRock.Draw(spriteBatch);
