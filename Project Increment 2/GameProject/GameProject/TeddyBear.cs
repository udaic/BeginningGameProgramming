    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                // creating the teddy bear projectile here w/ parameters
                ProjectileType projectileType = ProjectileType.TeddyBear;
                Texture2D teddybearsprite = Game1.GetProjectileSprite(projectileType);

                int x = drawRectangle.Center.X;
                int y = drawRectangle.Center.Y + GameConstants.TeddyBearProjectileOffset;


                // actual creation of projectile happens here
                Projectile projectile = new Projectile(projectileType, teddybearsprite, x, y, -GameConstants.TeddyBearProjectileSpeed);
