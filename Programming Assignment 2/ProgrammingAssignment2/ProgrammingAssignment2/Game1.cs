...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Texture2D imageA, imageB, imageC;
        ...
        protected override void LoadContent()
        {
            ...
            imageA = Content.Load<Texture2D>(@"graphics\image0");
            imageB = Content.Load<Texture2D>(@"graphics\image1");
            imageC = Content.Load<Texture2D>(@"graphics\image2");



            // STUDENTS: set the currentSprite variable to one of your sprite variables

            currentSprite = imageA;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > ChangeDelayTime)
            {
                ...
                {
                    currentSprite = imageB;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = imageC;
                }
                ...
                drawRectangle.X = ((graphics.PreferredBackBufferWidth - currentSprite.Width)/2);
                drawRectangle.Y = ((graphics.PreferredBackBufferHeight - currentSprite.Height)/2);
                ...
                speedX = (rand.Next(9) - 4);
                speedY = (rand.Next(9) - 4);
